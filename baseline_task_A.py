...
if __name__ == '__main__':
    ...
    parser.add_argument("--prediction_file_path", "-p", required=True, help="Path where to save the prediction file.",
                        type=str)
    ...
    prediction_path = args.prediction_file_path  # For example subtaskB_distilbert_predictions_monolingual1.jsonl
